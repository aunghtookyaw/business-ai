...
This module adds observability only; application routes and business logic remain
in scripts.receive_payment_server.
"""
...
from scripts.receive_payment_server import app
